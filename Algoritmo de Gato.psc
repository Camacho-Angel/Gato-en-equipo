Proceso Gato
    ...
    Mientras ~Terminado Hacer
        ...
        Si ~Ganador y CantTurnos < 9 Entonces
            ...
            // Determina a qué jugador le toca
            ...
            Repetir
                ...
                Sino
                    ...
                    Si Tab1[i,j] <> 0 Entonces
                        Escribir "Esa posición ya está ocupada, intente otra."
                        Pos <- 99
                    FinSi
                FinSi
            Hasta Que Pos <> 99
            ...
            // Verifica si hay 3 valores iguales en filas, columnas o diagonales
            ...
            // Cambia el turno si no hay ganador aún
            Si ~Ganador Entonces
